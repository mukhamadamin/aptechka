...
const ru: Dictionary = {
  ...
  "drawer.stats.title": "Статистика",
  "drawer.stats.label": "Статистика",
  "drawer.assistant.title": "Помощник",
  "drawer.assistant.label": "Помощник",
  "drawer.chat.title": "Семейный чат",
  "drawer.chat.label": "Чат",
  ...
  "subscription.statusActive": "Подписка активна",
  "subscription.statusInactive": "Подписка не активна",
  "subscription.description": "Чат, журнал приема и AI-помощник доступны после подписки.",
  "subscription.manageActivate": "Оформить подписку",
  "subscription.manageDeactivate": "Отменить подписку",
  "subscription.activated": "Подписка активирована.",
  "subscription.deactivated": "Подписка отключена.",
  "subscription.updateFail": "Не удалось обновить статус подписки.",
  "subscription.requiredTitle": "Нужна подписка",
  "subscription.requiredFeatureAssistant": "AI-помощник доступен только после подписки.",
  "subscription.requiredFeatureChat": "Семейный чат доступен только после подписки.",
  "subscription.requiredFeatureHistory": "Журнал приема лекарств доступен только после подписки.",
  "subscription.goToSettings": "Перейти в настройки",
  ...
  "chat.title": "Чат домохозяйства",
  "chat.subtitle": "Общий чат для всех участников вашей семьи.",
  "chat.loadingText": "Загружаем сообщения.",
  "chat.you": "Вы",
  "chat.sendFail": "Не удалось отправить сообщение.",
  "chat.empty.noHousehold": "Семья не подключена",
  "chat.empty.noHouseholdText": "Откройте настройки и присоединитесь к семье по коду.",
  "chat.empty.none": "Пока сообщений нет",
  "chat.empty.noneText": "Напишите первое сообщение для семьи.",
  "chat.input.placeholder": "Напишите сообщение...",
  "chat.input.send": "Отправить",
  "chat.validation.empty": "Сообщение не может быть пустым.",
  "chat.validation.tooLong": "Сообщение слишком длинное.",
...
const en: Dictionary = {
  ...
  "drawer.stats.title": "Statistics",
  "drawer.stats.label": "Statistics",
  "drawer.assistant.title": "Assistant",
  "drawer.assistant.label": "Assistant",
  "drawer.chat.title": "Family Chat",
  "drawer.chat.label": "Chat",
  ...
  "subscription.statusActive": "Subscription is active",
  "subscription.statusInactive": "Subscription is inactive",
  "subscription.description": "Chat, intake history and AI assistant are available after subscription.",
  "subscription.manageActivate": "Start subscription",
  "subscription.manageDeactivate": "Cancel subscription",
  "subscription.activated": "Subscription activated.",
  "subscription.deactivated": "Subscription disabled.",
  "subscription.updateFail": "Failed to update subscription status.",
  "subscription.requiredTitle": "Subscription required",
  "subscription.requiredFeatureAssistant": "AI assistant is available only with subscription.",
  "subscription.requiredFeatureChat": "Family chat is available only with subscription.",
  "subscription.requiredFeatureHistory": "Intake history is available only with subscription.",
  "subscription.goToSettings": "Open settings",
  ...
  "chat.subtitle": "A shared chat for everyone in your household.",
  "chat.loadingText": "Loading messages.",
  "chat.you": "You",
  "chat.sendFail": "Failed to send message.",
  "chat.empty.noHousehold": "No household connected",
  "chat.empty.noHouseholdText": "Open settings and join household by code.",
  "chat.empty.none": "No messages yet",
  "chat.empty.noneText": "Send the first message to your family.",
  "chat.input.placeholder": "Write a message...",
  "chat.input.send": "Send",
  "chat.validation.empty": "Message cannot be empty.",
  "chat.validation.tooLong": "Message is too long.",
